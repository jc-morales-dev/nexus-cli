...
NEXT_PUBLIC_NEXUS_APP_URL=http://localhost:${args.webPort}
`
...
# already sets NEXT_PUBLIC_NEXUS_APP_URL for all packages.
NEXT_PUBLIC_NEXUS_APP_URL=http://localhost:${args.webPort}
`
...
async function main(): Promise<void> {
  try {
    ...
    console.log(``)
    console.log(`⚠️  Note: NEXT_PUBLIC_NEXUS_APP_URL is set to http://localhost:${args.webPort}`)
