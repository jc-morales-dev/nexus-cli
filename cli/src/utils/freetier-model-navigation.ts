export type FreeTierModelNavigationDirection = 'forward' | 'backward'
...
export function nextFreeTierModelId(params: {
  modelIds: readonly string[]
  focusedId: string
  direction: FreeTierModelNavigationDirection
}): string | null {
...
export function freetierModelNavigationDirectionForKey(key: {
  name?: string
  shift?: boolean
  sequence?: string
  raw?: string
}): FreeTierModelNavigationDirection | null {
