...
import { VALID_USER_INFO_FIELDS, getUserInfoFromApiKey } from '@/db/user'
import { extractApiKeyFromHeader } from '@/util/auth'

export async function GET(req: NextRequest) {
  return _meGet({ req, getUserInfoFromApiKey, logger, trackEvent })
}
...
export async function _meGet(params: {
  req: NextRequest
