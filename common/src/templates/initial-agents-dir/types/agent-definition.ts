 ...
 *
 * This file provides TypeScript type definitions for creating custom Nexus agents.
...
export interface AgentDefinition {
  ...
  /** Other agents this agent can spawn, like 'nexus/file-picker@0.0.1'.
   *
   * Use the fully qualified agent id from the agent store, including publisher and version: 'nexus/file-picker@0.0.1'
