...
import type { Message } from '../messages/nexus-message'
...
export type PromptAiSdkStreamFn = (
  params: {
    ...
    costMode?: string
    /** Extra key/values merged into the request's `nexus_metadata` field.
     *  Used to forward client-scoped identifiers (e.g. `freetier_instance_id`)
