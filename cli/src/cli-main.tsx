// Main CLI module. Loaded by src/index.tsx via dynamic import AFTER the
// pre-init functions ran (tree-sitter wasm publish + BYOK key/env). Nothing in
// this module graph may assume it runs before pre-init.
import fs from 'fs'
