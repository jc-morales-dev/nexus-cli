...
if (isCI) {
  ...
  ensureEnvDefault('NEXUS_GITHUB_ID', 'test-id')
  ensureEnvDefault('NEXUS_GITHUB_SECRET', 'test-secret')
  ensureEnvDefault('FREETIER_GITHUB_ID', 'test-id')
  ensureEnvDefault('FREETIER_GITHUB_SECRET', 'test-secret')
