...
#   and stopping test sessions. Works with any TUI app (Nexus,
...
#
#   # Test Nexus (default when no --command specified)
...
#   ./scripts/tmux/tmux-cli.sh stop "$SESSION"
#
#   # Test a compiled Nexus binary
#   SESSION=$(./scripts/tmux/tmux-cli.sh start --binary)
#   # Or with custom path:
#   SESSION=$(./scripts/tmux/tmux-cli.sh start --binary ./path/to/nexus)
#
