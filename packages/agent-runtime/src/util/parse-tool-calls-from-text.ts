import {
  ...
  endToolTag,
  toolNameParam,
} from '@nexus/common/tools/constants'
...
/**
 * Parses text containing tool calls in the <nexus_tool_call> XML format,
...
export function parseTextWithToolCalls(text: string): ParsedSegment[] {
  ...
  // Match <nexus_tool_call>...</nexus_tool_call> blocks
...
/**
 * Parses tool calls from text in the <nexus_tool_call> XML format.
